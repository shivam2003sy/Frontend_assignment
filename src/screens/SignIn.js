...
function SignIn() {
  ...
  return (
    ...
    <div class="flex gap-3 ">
        ...
        <div className=" justify-self-end mr-80" ><a class="text-[#194BFB] " href="/"> Forget Password?</a></div>
                            
                        </div>
                    </div>
                    <Button name="Sign up"/>
                    <p class="text-sm text-center my-5 text-gray-500">Dont have account? <a class="text-blue-700" href="/">Sign up</a></p>
