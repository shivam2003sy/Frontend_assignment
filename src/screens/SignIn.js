...
import logo from "../asset/logolight.svg"
...
function SignIn() {
  ...
  return (
    <div class="flex justify-center items-center bg-gray-200 min-h-screen">
        ...
        <div class="flex h-full w-full">
            <div class="left_side h-fit rounded-lg p-3 w-6/12  text-center mr-10 ml-20">
                ...
                <path fill="#e53935" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039 l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"></path><path fill="#4caf50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36 c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"></path>
                <path fill="#1565c0" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571 c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path></svg>
    ...
    <button class="submit_btn mt-4  h-10 w-full bg-[#194BFB] text-white cursor-pointer transition-all  flex justify-center items-center rounded-[10px]">Sign In</button>
                    ...
                    <p class="text-sm text-center my-5 text-gray-500">Dont have account? <Link to='/signup' class="text-blue-700" href="/">Sign up</Link></p>
                    
                </div> 
                
            </div>
            <div class="right_side bg-black h-fit w-fit md:rounded-lg hidden md:block  md:bg-white">
                <img class="md:h-full object-cover h-full md:w-full mr-20 w-20" src={Signin} alt="signin"/>
            </div>
        </div>
